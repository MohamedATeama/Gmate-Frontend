    ...
    <>
      ...
      >
        ...
        <nav className="flex flex-1 flex-col gap-2 overflow-y-auto p-4 sm:p-6">
          <button className="bg-inline-background text-inline-primary before:bg-inline-primary relative inline-flex items-center gap-2 rounded-lg px-3 py-2.5 text-start text-sm font-semibold transition-colors sm:px-4 sm:py-3 before:absolute before:inset-0 before:top-0 before:left-0 before:block before:h-full before:w-1 before:rounded-l-md sm:before:w-2">
            <RiGalleryView2 className="shrink-0" size={20} />
            <span className="truncate">All Tasks</span>
          </button>
          <button className="text-muted-foreground hover:bg-inline-background relative inline-flex items-center gap-2 rounded-lg px-3 py-2.5 text-start text-sm font-medium transition-colors sm:px-4 sm:py-3">
        ...
        <div className="border-sidebar-border border-t p-4 sm:p-6">
          <Button
            className="w-full font-bold bg-inline-primary hover:bg-inline-primary/80 text-sm sm:text-base"
            size="sm"
          >
